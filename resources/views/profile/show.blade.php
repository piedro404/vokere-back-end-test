        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 flex flex-col gap-3">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h1 class="text-lg">Perfil do {{ $user->name }}</h1>
                </div>
            </div>
                    ...
                    <div class="mx-auto w-full max-w-[550px] bg-white">
                        <div class="mb-6">
                            <div class="w-full relative p-6 "
                                ...
                                @if ($user->avatar)
                                    <img src="{{ url('storage/' . $user->avatar) }}" class="mt-4 mx-auto h-40 w-40 rounded-full"
                                        id="preview">
                                @else
                                    <img src="{{ url('images/profileDefault.webp') }}" class="mt-4 mx-auto h-40 w-40 rounded-full"
                                        id="preview">
                                @endif
                            </div>
                            <p class="text-center block text-base font-medium text-[#07074D] mb-1">Avatar de {{ $user->name }}</p>
                        </div>
                        ...
                        <div class="-mx-3 flex flex-wrap">
                            <div class="w-full px-3 sm:w-1/2">
                                <div class="mb-3">
                                    ...
                                    <p
                                        class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md">
                                        {{ $user->formatted_date_of_birth }}</p>
                                </div>
                            </div>
                            <div class="w-full px-3 sm:w-1/2">
                                <div class="mb-3">
