        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 flex flex-col gap-3">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h1 class="text-lg">Configuração de {{ $user->name }}
                    </h1>
                </div>
            </div>
                        ...
                        <form action="{{ route('auth.update') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    @if (isset($user))
                                        @if ($user->avatar)
                                            <img src="{{ url('storage/' . $user->avatar) }}"
                                                class="mt-4 mx-auto max-h-40" id="preview">
                                        @else
                                            <img src="{{ url('images/profileDefault.webp') }}"
                                                class="mt-4 mx-auto max-h-40" id="preview">
                                        @endif
                                    @else
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" id="name" required minlength="3"
                                    malength="255" value="{{ $user->name ?? old('name') }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" name="email" id="email" required minlength="3"
                                    maxlength="255" value="{{ $user->email ?? old('email') }}"
                                ...
                                <div class="w-full px-3 sm:w-1/2">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="date_of_birth" id="date_of_birth" required
                                            ...
                                            value="{{ $user->formatted_date_of_birth ?? old('date_of_birth') }}"
                                            class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                    </div>
                                </div>
                                <div class="w-full px-3 sm:w-1/2">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="cpf" id="cpf" placeholder="123.456.789-10"
                                            required value="{{ $user->cpf ?? old('cpf') }}"
                                            class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="w-full px-3 sm:w-1/2">
                                        <div class="mb-3">
                                            <input type="text" name="street" id="street" placeholder="Rua"
                                                required minlength="3" value="{{ $location->street ?? old('street') }}"
                                                maxlength="255"
                                                class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="w-full px-3 sm:w-1/1">
                                        <div class="mb-3">
                                            <input type="text" name="complement" id="complement" minlength="3"
                                                maxlength="255"
                                                value="{{ $location->complement ?? old('complement') }}"
                                    ...
                                    <div class="w-full px-3 sm:w-1/2">
                                        <div class="mb-3">
                                            <input type="text" name="neighborhood" id="neighborhood" required
                                                ...
                                                value="{{ $location->neighborhood ?? old('neighborhood') }}"
                                                placeholder="Bairro"
                                                class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                        </div>
                                    </div>
                                    <div class="w-full px-3 sm:w-1/2">
                                        <div class="mb-3">
                                            <input type="text" name="cep" id="cep" placeholder="CEP"
                                                required value="{{ $location->cep ?? old('cep') }}"
                                                class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                        </div>
                                    </div>
                                    <div class="w-full px-3 sm:w-1/2">
                                        <div class="mb-3">
                                            <input type="text" name="city" id="city" placeholder="Cidade"
                                                required minlength="3" value="{{ $location->city ?? old('city') }}"
                                                maxlength="255"
                                                class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                        </div>
                                    </div>
